        ...
        <div
          className={
            hideChrome
              ...
              : "relative mx-auto flex min-h-dvh w-full max-w-lg flex-col bg-background md:max-w-2xl lg:max-w-5xl lg:shadow-[0_0_0_1px_rgba(0,0,0,0.04)] dark:lg:shadow-[0_0_0_1px_rgba(255,255,255,0.06)]"
          }
        >
          <main
            className={
